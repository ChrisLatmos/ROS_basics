...
"""autogenerated by genpy from simple_robot_msgs/GetRobotPoseActionFeedback.msg. Do not edit."""
import sys
...
class GetRobotPoseActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "simple_robot_msgs/GetRobotPoseActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','simple_robot_msgs/GetRobotPoseFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetRobotPoseActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = simple_robot_msgs.msg.GetRobotPoseFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = simple_robot_msgs.msg.GetRobotPoseFeedback()
