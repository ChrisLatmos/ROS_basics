...
(cl:in-package service_temp-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <WordCount-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WordCount-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name service_temp-srv:<WordCount-request> is deprecated: use service_temp-srv:WordCount-request instead.")))

(cl:ensure-generic-function 'words-val :lambda-list '(m))
(cl:defmethod words-val ((m <WordCount-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader service_temp-srv:words-val is deprecated.  Use service_temp-srv:words instead.")
  (words m))
...
(cl:defmethod cl:initialize-instance :after ((m <WordCount-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WordCount-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name service_temp-srv:<WordCount-response> is deprecated: use service_temp-srv:WordCount-response instead.")))

(cl:ensure-generic-function 'count-val :lambda-list '(m))
(cl:defmethod count-val ((m <WordCount-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader service_temp-srv:count-val is deprecated.  Use service_temp-srv:count instead.")
  (count m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<WordCount-response>)))
  ...
  "service_temp/WordCountResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'WordCount-response)))
  "Returns string type for a service object of type 'WordCount-response"
  "service_temp/WordCountResponse")
