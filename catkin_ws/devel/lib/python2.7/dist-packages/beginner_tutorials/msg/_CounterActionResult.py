...
"""autogenerated by genpy from beginner_tutorials/CounterActionResult.msg. Do not edit."""
import sys
...
class CounterActionResult(genpy.Message):
  ...
  _type = "beginner_tutorials/CounterActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','beginner_tutorials/CounterResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = beginner_tutorials.msg.CounterResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = beginner_tutorials.msg.CounterResult()
