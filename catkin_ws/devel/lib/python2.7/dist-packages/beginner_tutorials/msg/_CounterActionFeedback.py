...
"""autogenerated by genpy from beginner_tutorials/CounterActionFeedback.msg. Do not edit."""
import sys
...
class CounterActionFeedback(genpy.Message):
  _md5sum = "c1ef0338f972e21fcb2218cf73b46f6a"
  _type = "beginner_tutorials/CounterActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','beginner_tutorials/CounterFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = beginner_tutorials.msg.CounterFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = beginner_tutorials.msg.CounterFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_i.pack(self.feedback.current_state))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.current_state,) = _struct_i.unpack(str[start:end])
      return self
