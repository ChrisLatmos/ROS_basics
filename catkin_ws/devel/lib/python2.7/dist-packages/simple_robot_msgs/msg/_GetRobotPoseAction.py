...
"""autogenerated by genpy from simple_robot_msgs/GetRobotPoseAction.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import simple_robot_msgs.msg
import genpy
import actionlib_msgs.msg
import std_msgs.msg

class GetRobotPoseAction(genpy.Message):
  _md5sum = "1be0d173414bdc2ff88cd4b96a81cabf"
  _type = "simple_robot_msgs/GetRobotPoseAction"
...
"""
  ...
  _slot_types = ['simple_robot_msgs/GetRobotPoseActionGoal','simple_robot_msgs/GetRobotPoseActionResult','simple_robot_msgs/GetRobotPoseActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetRobotPoseAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = simple_robot_msgs.msg.GetRobotPoseActionGoal()
      if self.action_result is None:
        self.action_result = simple_robot_msgs.msg.GetRobotPoseActionResult()
      if self.action_feedback is None:
        self.action_feedback = simple_robot_msgs.msg.GetRobotPoseActionFeedback()
    else:
      self.action_goal = simple_robot_msgs.msg.GetRobotPoseActionGoal()
      self.action_result = simple_robot_msgs.msg.GetRobotPoseActionResult()
      self.action_feedback = simple_robot_msgs.msg.GetRobotPoseActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2q3I.pack(_x.action_result.result.x, _x.action_result.result.y, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_result.result.x, _x.action_result.result.y, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_2q3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
